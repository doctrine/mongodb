...
class CollectionEventsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFindAndRemove()
    {
        ...
        $this->expectEvents([
            [Events::preFindAndRemove, new EventArgs($collection, $query, $options)],
    ...
    public function testRemove()
    {
        ...
        $this->expectEvents([
            [Events::preRemove, new EventArgs($collection, $query, $options)],
            [Events::postRemove, new EventArgs($collection, $result)],
        ]);
    ...
    public function testUpdate()
    {
        ...
        $this->expectEvents([
            ...
            [Events::postUpdate, new EventArgs($collection, $result)],
        ]);
